...
const AdminNavbar = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-between p-4 bg-black text-white">
        ...
        <input type='text' placeholder='search' className="bg-[#242526] text-gray-200 text-sm px-4 py-2 rounded-full w-96 pr-10 focus:outline-none focus:ring-2 focus:ring-gray-500" />
